...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	...
	<ul class="navbar-nav ml-auto">
		...
		<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_PO')">
			...
			<li class="nav-item"><a class="nav-link"
				href="<c:url value="/usercust/toCreate" />"><spring:message
						code="entities.user.customer.create.title" /></a></li>



			<li class="nav-item"><a class="nav-link"
				href="<c:url value="/usercollab/toCreate" />"><spring:message
						code="entities.user.collab.create.title" /></a></li>



			<li class="nav-item"><a class="nav-link"
				href="<c:url value="/list/list" />"><spring:message
						code="list.title" /></a></li>


			<li class="nav-item"><a class="nav-link"
				href="<c:url value="/listpo/list" />"><spring:message
						code="entities.finance.list.po.title.short" /></a></li>


			<li class="nav-item"><a class="nav-link"
				href="<c:url value="/perf/toUpdate" />"><spring:message
						code="entities.perf.param.create.title.short" /></a></li>
		...
		<sec:authorize access="hasRole('ROLE_BANKER')">
			...
			<li class="nav-item"><a class="nav-link"
				href="<c:url value="/listba/list" />"><spring:message
						code="entities.finance.list.po.title.short" /></a></li>
